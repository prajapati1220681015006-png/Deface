...
my_cook = {
	"ZHE" : "f806654b99c7a0b3a4424317024f6d3e",
	"PHPSESSID" : "8m0aip6ft0vlmh02b3vbto94s6"
	}
...
/_/   \_\_| |_| |_|\__,_/___|_|\__, |_| |_| |_|\_\_|_|____/|_|   
                	...
                	Greetz To : \033[93mKabyles \033[92mHackers  \033[91m|D\033[92mz| \033[91mAlgeria \033[92mHackers
                                     """)
	slowprint("\n\t\t\t\t\tPowered By : Blackhat Pakistan " + "\n\t\t\t\t\t\t Telegram : @Blackhatpakistan_admin  " + "\n\t\t\t\t\t\t     YouTube : https://www.youtube.com/channel/UCRx8ACiYlnsjY2zzIH58YwQ?view_as=subscriber")
	print("")
	print("""
